...
The <b>crypto.aes_decrypt</b> method decrypts the given data using the given key and IV (Initialization Vector).

### crypto.aes_encrypt

`crypto.aes_encrypt(key: List<int>, iv: List<int>, data: List<int>) -> List<int>`

The <b>crypto.aes_encrypt</b> method encrypts the given data using the given key and IV (Initialization Vector).
...
The <b>pivot.create_portal</b> method opens a bi-directional stream portal.
...
The <b>random.uuid</b> method returns a randomly generated UUID (v4) string.
