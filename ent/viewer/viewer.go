...
// ErrInvalidKind occurs when an invalid type of viewer is retrieved from the context.
// ErrNoViewer occurs when no viewer can be retrieved from the context.
var (
	ErrInvalidKind = fmt.Errorf("invalid viewer kind in context")
