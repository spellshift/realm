...
mod tests {
    ...
    const HELLO_WORLD_BYTES: [u32; 14] = [0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21, 0x0a];
    ...
    fn test_read_glob() -> anyhow::Result<()> {
        ...
        assert_eq!(res, Vec::from([0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x0a]));
        Ok(())
    }
}
