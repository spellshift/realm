...
pub fn replace(haystack: String, pattern: String, value: String) -> Result<String> {
...
mod tests {
    ...
    fn test_replace() -> anyhow::Result<()> {
        ...
        let m = replace(test_haystack, test_pattern, test_value)?;
    ...
    fn test_replace_not_found() -> anyhow::Result<()> {
        ...
        let test_value = String::from("That cannot soar.");
        let m = replace(test_haystack.clone(), test_pattern, test_value)?;
