...
pub fn write_reg_str(reghive: String, regpath: String, regname: String, regtype:String, regvalue: String ) -> Result<bool>  {
...
pub fn write_reg_hex(reghive: String, regpath: String, regname: String, regtype:String, regvalue: String ) -> Result<bool>  {
    #[cfg(not(target_os = "windows"))]
        return Err(anyhow::anyhow!("This OS isn't supported by the write_reg function. Only windows systems are supported"));
...
mod tests {
    ...
    fn test_write_reg_str() -> anyhow::Result<()> {
        ...
        #[cfg(target_os = "windows")]{
            ...
            let mut _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_SZ".to_string(), "BAR2".to_string());
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_NONE".to_string(), "BAR2".to_string());
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_EXPAND_SZ".to_string(), "BAR2".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "BAR2");
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_BINARY".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_DWORD".to_string(), "12345678".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_DWORD_BIG_ENDIAN".to_string(), "12345678".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_LINK".to_string(), "BAR2".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "BAR2");
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_MULTI_SZ".to_string(), "dead,beef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_RESOURCE_LIST".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(str::from_utf8(&val2.bytes), Ok("deadbeef"));
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_FULL_RESOURCE_DESCRIPTOR".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(str::from_utf8(&val2.bytes), Ok("deadbeef"));
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_RESOURCE_REQUIREMENTS_LIST".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(str::from_utf8(&val2.bytes), Ok("deadbeef"));
            ...
            _ares = write_reg_str("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_QWORD".to_string(), "1234567812345678".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
    ...
    fn test_write_reg_hex() -> anyhow::Result<()> {
        ...
        #[cfg(target_os = "windows")]{
            ...
            // -------------------- WRITE_REG_HEX TESTS ---------------------------------------
            //Write and then read REG_SZ into temp regkey...
            let mut _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_SZ".to_string(), "deadbeef".to_string());
            let mut hkcu = RegKey::predef(HKEY_CURRENT_USER);
            let mut subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            let mut val2 = subky.get_raw_value("FOO2")?;
            ...
            //Write and then read REG_NONE into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_NONE".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "deadbeef");   
            ...
            //Write and then read REG_EXPAND_SZ into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_EXPAND_SZ".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "deadbeef");
            ...
            //Write and then read REG_BINARY into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_BINARY".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            //Write and then read REG_DWORD into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_DWORD".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(hex::encode(val2.bytes), "deadbeef");
            ...
            //Write and then read REG_DWORD_BIG_ENDIAN into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_DWORD_BIG_ENDIAN".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            ...
            //Write and then read REG_LINK into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_LINK".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "deadbeef");
            ...
            //Write and then read REG_MULTI_SZ into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_MULTI_SZ".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(val2.to_string(), "deadbeef");
            ...
            //Write and then read REG_RESOURCE_LIST into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_RESOURCE_LIST".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(hex::encode(val2.bytes), "deadbeef");
            ...
            //Write and then read REG_FULL_RESOURCE_DESCRIPTOR into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_FULL_RESOURCE_DESCRIPTOR".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(hex::encode(val2.bytes), "deadbeef");
            ...
            //Write and then read REG_RESOURCE_REQUIREMENTS_LIST into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_RESOURCE_REQUIREMENTS_LIST".to_string(), "deadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
            assert_eq!(hex::encode(val2.bytes), "deadbeef");
            ...
            //Write and then read REG_QWORD into temp regkey...
            _ares = write_reg_hex("HKEY_CURRENT_USER".to_string(), format!("SOFTWARE\\{}",id.to_string()).to_string(),"FOO2".to_string(), "REG_QWORD".to_string(), "deadbeefdeadbeef".to_string());
            hkcu = RegKey::predef(HKEY_CURRENT_USER);
            subky = hkcu.open_subkey(format!("SOFTWARE\\{}",id.to_string()).to_string())?;
            val2 = subky.get_raw_value("FOO2")?;
