...
fn test_set_argument_validation() {
    // Pop takes 0 args
    assert::fail("s = {1}; s.pop(1)", "TypeError: pop() takes exactly 0 arguments");

    // Clear takes 0 args
    assert::fail("s = {1}; s.clear(1)", "TypeError: clear() takes exactly 0 arguments");

    // Add takes 1 arg
    assert::fail("s = {1}; s.add()", "TypeError: add() takes exactly 1 argument");
    assert::fail("s = {1}; s.add(1, 2)", "TypeError: add() takes exactly 1 argument");
}
...
fn test_dict_argument_validation() {
    ...
    assert::fail("d = {}; d.update(1, 2)", "TypeError: update() takes exactly 1 argument");
