...
impl Default for ProcessLibraryFake {
    fn default() -> Self {
        ...
        map.insert(1, ProcessInfo { pid: 1, ppid: 0, name: "init".to_string(), user: "root".to_string(), arch: "x86_64".to_string() });
        map.insert(2, ProcessInfo { pid: 2, ppid: 0, name: "kthreadd".to_string(), user: "root".to_string(), arch: "x86_64".to_string() });
        map.insert(100, ProcessInfo { pid: 100, ppid: 1, name: "systemd".to_string(), user: "root".to_string(), arch: "x86_64".to_string() });
        map.insert(1000, ProcessInfo { pid: 1000, ppid: 100, name: "sshd".to_string(), user: "root".to_string(), arch: "x86_64".to_string() });
        map.insert(1001, ProcessInfo { pid: 1001, ppid: 1000, name: "bash".to_string(), user: "user".to_string(), arch: "x86_64".to_string() });
        map.insert(1337, ProcessInfo { pid: 1337, ppid: 1001, name: "eldritch".to_string(), user: "user".to_string(), arch: "x86_64".to_string() });
