...
mod tests {
    ...
    impl Agent for MockAgent {
        ...
        // Unused stubs
        fn fetch_asset(&self, _: pb::c2::FetchAssetRequest) -> Result<Vec<u8>, String> { Err("".into()) }
        fn report_credential(&self, _: pb::c2::ReportCredentialRequest) -> Result<pb::c2::ReportCredentialResponse, String> { Err("".into()) }
        fn report_file(&self, _: pb::c2::ReportFileRequest) -> Result<pb::c2::ReportFileResponse, String> { Err("".into()) }
        fn report_process_list(&self, _: pb::c2::ReportProcessListRequest) -> Result<pb::c2::ReportProcessListResponse, String> { Err("".into()) }
        fn report_task_output(&self, _: pb::c2::ReportTaskOutputRequest) -> Result<pb::c2::ReportTaskOutputResponse, String> { Err("".into()) }
        fn reverse_shell(&self) -> Result<(), String> { Err("".into()) }
        fn start_reverse_shell(&self, _: i64, _: Option<String>) -> Result<(), String> { Err("".into()) }
        fn start_repl_reverse_shell(&self, _: i64) -> Result<(), String> { Err("".into()) }
