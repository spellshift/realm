...
fn test_reverse_shell_pty_delegation() {
    ...
    let task_id = 999;
    let lib = StdPivotLibrary::new(agent.clone(), pb::c2::TaskContext{ task_id: 0, jwt:  "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJiZWFjb25faWQiOjQyOTQ5Njc0OTUsImV4cCI6MTc2Nzc1MTI3MSwiaWF0IjoxNzY3NzQ3NjcxfQ.wVFQemOmhdjCSGdb_ap_DkA9GcGqDHt3UOn2w9fE0nc7nGLbAWqQkkOwuMqlsC9FXZoYglOz11eTUt9UyrmiBQ".to_string()});
