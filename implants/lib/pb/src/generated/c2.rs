...
pub struct ShellTaskOutput {
    ...
    pub output: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "3")]
    pub error: ::core::option::Option<ShellTaskError>,
    /// Indicates the UTC timestamp task execution began, set only in the first message for reporting.
    #[prost(message, optional, tag = "4")]
    pub exec_started_at: ::core::option::Option<::prost_types::Timestamp>,
    /// Indicates the UTC timestamp task execution completed, set only in last message for reporting.
...
pub mod fetch_asset_request {
    ...
    pub enum Context {
        ...
        #[prost(message, tag = "2")]
        ShellContext(super::ShellTaskContext),
    }
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct ReportOutputRequest {
    #[prost(oneof = "report_output_request::Context", tags = "1, 2")]
    pub context: ::core::option::Option<report_output_request::Context>,
    #[prost(oneof = "report_output_request::Output", tags = "3, 4")]
    pub output: ::core::option::Option<report_output_request::Output>,
}
...
pub mod report_output_request {
    ...
    pub enum Output {
        ...
        #[prost(message, tag = "4")]
        ShellTaskOutput(super::ShellTaskOutput),
    }
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
