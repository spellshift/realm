    ...
    impl Kind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::SshKey => "KIND_SSH_KEY",
                Self::NtlmHash => "KIND_NTLM_HASH",
            }
        }
    ...
    impl Status {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Run => "STATUS_RUN",
                Self::Sleep => "STATUS_SLEEP",
                Self::Stop => "STATUS_STOP",
                Self::Zombie => "STATUS_ZOMBIE",
                Self::Tracing => "STATUS_TRACING",
                Self::Dead => "STATUS_DEAD",
                Self::WakeKill => "STATUS_WAKE_KILL",
