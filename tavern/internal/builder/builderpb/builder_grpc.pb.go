...
type BuilderClient interface {
	...
	DownloadTome(ctx context.Context, in *DownloadTomeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadTomeResponse], error)
}
...
func (c *builderClient) DownloadTome(ctx context.Context, in *DownloadTomeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadTomeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Builder_DownloadTomeClient = grpc.ServerStreamingClient[DownloadTomeResponse]
...
type BuilderServer interface {
	...
	DownloadTome(*DownloadTomeRequest, grpc.ServerStreamingServer[DownloadTomeResponse]) error
...
func (UnimplementedBuilderServer) DownloadTome(*DownloadTomeRequest, grpc.ServerStreamingServer[DownloadTomeResponse]) error {
	return status.Error(codes.Unimplemented, "method DownloadTome not implemented")
}
...
func _Builder_DownloadTome_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BuilderServer).DownloadTome(m, &grpc.GenericServerStream[DownloadTomeRequest, DownloadTomeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Builder_DownloadTomeServer = grpc.ServerStreamingServer[DownloadTomeResponse]
