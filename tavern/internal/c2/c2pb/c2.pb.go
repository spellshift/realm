...
var file_c2_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x42, 0x0a,
	...
	0x61, 0x22, 0x2a, 0x0a, 0x14, 0x52, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x53, 0x68, 0x65, 0x6c,
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xfc, 0x03,
...
var file_c2_proto_goTypes = []interface{}{
	...
	(*ReverseShellRequest)(nil),       // 19: c2.ReverseShellRequest
	(*ReverseShellResponse)(nil),      // 20: c2.ReverseShellResponse
	(*epb.Tome)(nil),                  // 21: eldritch.Tome
	(*timestamp.Timestamp)(nil),       // 22: google.protobuf.Timestamp
	(*epb.Credential)(nil),            // 23: eldritch.Credential
	(*epb.File)(nil),                  // 24: eldritch.File
	(*epb.ProcessList)(nil),           // 25: eldritch.ProcessList
}
var file_c2_proto_depIdxs = []int32{
	...
	21, // 3: c2.Task.tome:type_name -> eldritch.Tome
	5,  // 4: c2.TaskOutput.error:type_name -> c2.TaskError
	22, // 5: c2.TaskOutput.exec_started_at:type_name -> google.protobuf.Timestamp
	22, // 6: c2.TaskOutput.exec_finished_at:type_name -> google.protobuf.Timestamp
	2,  // 7: c2.ClaimTasksRequest.beacon:type_name -> c2.Beacon
	4,  // 8: c2.ClaimTasksResponse.tasks:type_name -> c2.Task
	23, // 9: c2.ReportCredentialRequest.credential:type_name -> eldritch.Credential
	24, // 10: c2.ReportFileRequest.chunk:type_name -> eldritch.File
	25, // 11: c2.ReportProcessListRequest.list:type_name -> eldritch.ProcessList
	6,  // 12: c2.ReportTaskOutputRequest.output:type_name -> c2.TaskOutput
	7,  // 13: c2.C2.ClaimTasks:input_type -> c2.ClaimTasksRequest
	9,  // 14: c2.C2.FetchAsset:input_type -> c2.FetchAssetRequest
	...
	19, // 19: c2.C2.ReverseShell:input_type -> c2.ReverseShellRequest
	8,  // 20: c2.C2.ClaimTasks:output_type -> c2.ClaimTasksResponse
	10, // 21: c2.C2.FetchAsset:output_type -> c2.FetchAssetResponse
	12, // 22: c2.C2.ReportCredential:output_type -> c2.ReportCredentialResponse
	14, // 23: c2.C2.ReportFile:output_type -> c2.ReportFileResponse
	16, // 24: c2.C2.ReportProcessList:output_type -> c2.ReportProcessListResponse
	18, // 25: c2.C2.ReportTaskOutput:output_type -> c2.ReportTaskOutputResponse
	20, // 26: c2.C2.ReverseShell:output_type -> c2.ReverseShellResponse
