...
var file_c2_proto_goTypes = []any{
	(ActiveTransport_Type)(0),         // 0: c2.ActiveTransport.Type
	(Host_Platform)(0),                // 1: c2.Host.Platform
	(*Agent)(nil),                     // 2: c2.Agent
	(*ActiveTransport)(nil),           // 3: c2.ActiveTransport
	...
	(*CreatePortalRequest)(nil),       // 21: c2.CreatePortalRequest
	(*CreatePortalResponse)(nil),      // 22: c2.CreatePortalResponse
	...
	(*portalpb.Mote)(nil),             // 28: portal.Mote
}
var file_c2_proto_depIdxs = []int32{
	0,  // 0: c2.ActiveTransport.type:type_name -> c2.ActiveTransport.Type
	5,  // 1: c2.Beacon.host:type_name -> c2.Host
	2,  // 2: c2.Beacon.agent:type_name -> c2.Agent
	3,  // 3: c2.Beacon.active_transport:type_name -> c2.ActiveTransport
	1,  // 4: c2.Host.platform:type_name -> c2.Host.Platform
	23, // 5: c2.Task.tome:type_name -> eldritch.Tome
	7,  // 6: c2.TaskOutput.error:type_name -> c2.TaskError
	24, // 7: c2.TaskOutput.exec_started_at:type_name -> google.protobuf.Timestamp
	24, // 8: c2.TaskOutput.exec_finished_at:type_name -> google.protobuf.Timestamp
	4,  // 9: c2.ClaimTasksRequest.beacon:type_name -> c2.Beacon
	6,  // 10: c2.ClaimTasksResponse.tasks:type_name -> c2.Task
	25, // 11: c2.ReportCredentialRequest.credential:type_name -> eldritch.Credential
	26, // 12: c2.ReportFileRequest.chunk:type_name -> eldritch.File
	27, // 13: c2.ReportProcessListRequest.list:type_name -> eldritch.ProcessList
	8,  // 14: c2.ReportTaskOutputRequest.output:type_name -> c2.TaskOutput
	28, // 15: c2.CreatePortalRequest.mote:type_name -> portal.Mote
	28, // 16: c2.CreatePortalResponse.mote:type_name -> portal.Mote
	9,  // 17: c2.C2.ClaimTasks:input_type -> c2.ClaimTasksRequest
	11, // 18: c2.C2.FetchAsset:input_type -> c2.FetchAssetRequest
	13, // 19: c2.C2.ReportCredential:input_type -> c2.ReportCredentialRequest
	15, // 20: c2.C2.ReportFile:input_type -> c2.ReportFileRequest
	17, // 21: c2.C2.ReportProcessList:input_type -> c2.ReportProcessListRequest
	19, // 22: c2.C2.ReportTaskOutput:input_type -> c2.ReportTaskOutputRequest
	21, // 23: c2.C2.CreatePortal:input_type -> c2.CreatePortalRequest
	10, // 24: c2.C2.ClaimTasks:output_type -> c2.ClaimTasksResponse
	12, // 25: c2.C2.FetchAsset:output_type -> c2.FetchAssetResponse
	14, // 26: c2.C2.ReportCredential:output_type -> c2.ReportCredentialResponse
	16, // 27: c2.C2.ReportFile:output_type -> c2.ReportFileResponse
	18, // 28: c2.C2.ReportProcessList:output_type -> c2.ReportProcessListResponse
	20, // 29: c2.C2.ReportTaskOutput:output_type -> c2.ReportTaskOutputResponse
	22, // 30: c2.C2.CreatePortal:output_type -> c2.CreatePortalResponse
