...
type ReportFactRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Context       *TaskContext           `protobuf:"bytes,1,opt,name=context,proto3" json:"context,omitempty"`
	Fact          *epb.Fact              `protobuf:"bytes,2,opt,name=fact,proto3" json:"fact,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReportFactRequest) Reset() {
	*x = ReportFactRequest{}
...
func (x *ReportFactRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportFactRequest) ProtoMessage() {}

func (x *ReportFactRequest) ProtoReflect() protoreflect.Message {
	mi := &file_c2_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportFactRequest.ProtoReflect.Descriptor instead.
func (*ReportFactRequest) Descriptor() ([]byte, []int) {
	return file_c2_proto_rawDescGZIP(), []int{15}
}

func (x *ReportFactRequest) GetContext() *TaskContext {
	if x != nil {
		return x.Context
	}
	return nil
...
func (x *ReportFactRequest) GetFact() *epb.Fact {
	if x != nil {
		return x.Fact
	}
	return nil
...
type ReportFactResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReportFactResponse) Reset() {
	*x = ReportFactResponse{}
	mi := &file_c2_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReportFactResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportFactResponse) ProtoMessage() {}

func (x *ReportFactResponse) ProtoReflect() protoreflect.Message {
	mi := &file_c2_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportFactResponse.ProtoReflect.Descriptor instead.
func (*ReportFactResponse) Descriptor() ([]byte, []int) {
...
const file_c2_proto_rawDesc = "" +
	...
	"\x05tasks\x18\x01 \x03(\v2\b.c2.TaskR\x05tasks\"R\n" +
	...
	"credential\"\x1a\n" +
	"\x18ReportCredentialResponse\"b\n" +
	"\x11ReportFactRequest\x12)\n" +
	"\acontext\x18\x01 \x01(\v2\x0f.c2.TaskContextR\acontext\x12\"\n" +
	"\x04fact\x18\x02 \x01(\v2\x0e.eldritch.FactR\x04fact\"\x14\n" +
	"\x12ReportFactResponse\"d\n" +
	...
	"\acontext\x18\x02 \x01(\v2\x0f.c2.TaskContextR\acontext\"\x1a\n" +
	...
	"\x1fREVERSE_SHELL_MESSAGE_KIND_PING\x10\x022\x82\x05\n" +
	"\x02C2\x12=\n" +
	"\n" +
	...
	"\n" +
	"ReportFact\x12\x15.c2.ReportFactRequest\x1a\x16.c2.ReportFactResponse\x12=\n" +
	"\n" +
...
var file_c2_proto_goTypes = []any{
	...
	(*ReportFactRequest)(nil),         // 18: c2.ReportFactRequest
	(*ReportFactResponse)(nil),        // 19: c2.ReportFactResponse
	...
	(*epb.Fact)(nil),                  // 33: eldritch.Fact
	(*epb.File)(nil),                  // 34: eldritch.File
	(*epb.ProcessList)(nil),           // 35: eldritch.ProcessList
	(*portalpb.Mote)(nil),             // 36: portal.Mote
}
var file_c2_proto_depIdxs = []int32{
	...
	32, // 14: c2.ReportCredentialRequest.credential:type_name -> eldritch.Credential
	11, // 15: c2.ReportFactRequest.context:type_name -> c2.TaskContext
	33, // 16: c2.ReportFactRequest.fact:type_name -> eldritch.Fact
	11, // 17: c2.ReportFileRequest.context:type_name -> c2.TaskContext
	34, // 18: c2.ReportFileRequest.chunk:type_name -> eldritch.File
	11, // 19: c2.ReportProcessListRequest.context:type_name -> c2.TaskContext
	35, // 20: c2.ReportProcessListRequest.list:type_name -> eldritch.ProcessList
	10, // 21: c2.ReportTaskOutputRequest.output:type_name -> c2.TaskOutput
	11, // 22: c2.ReportTaskOutputRequest.context:type_name -> c2.TaskContext
	0,  // 23: c2.ReverseShellRequest.kind:type_name -> c2.ReverseShellMessageKind
	11, // 24: c2.ReverseShellRequest.context:type_name -> c2.TaskContext
	0,  // 25: c2.ReverseShellResponse.kind:type_name -> c2.ReverseShellMessageKind
	11, // 26: c2.CreatePortalRequest.context:type_name -> c2.TaskContext
	36, // 27: c2.CreatePortalRequest.mote:type_name -> portal.Mote
	36, // 28: c2.CreatePortalResponse.mote:type_name -> portal.Mote
	12, // 29: c2.C2.ClaimTasks:input_type -> c2.ClaimTasksRequest
	14, // 30: c2.C2.FetchAsset:input_type -> c2.FetchAssetRequest
	16, // 31: c2.C2.ReportCredential:input_type -> c2.ReportCredentialRequest
	18, // 32: c2.C2.ReportFact:input_type -> c2.ReportFactRequest
	20, // 33: c2.C2.ReportFile:input_type -> c2.ReportFileRequest
	22, // 34: c2.C2.ReportProcessList:input_type -> c2.ReportProcessListRequest
	24, // 35: c2.C2.ReportTaskOutput:input_type -> c2.ReportTaskOutputRequest
	26, // 36: c2.C2.ReverseShell:input_type -> c2.ReverseShellRequest
	28, // 37: c2.C2.CreatePortal:input_type -> c2.CreatePortalRequest
	13, // 38: c2.C2.ClaimTasks:output_type -> c2.ClaimTasksResponse
	15, // 39: c2.C2.FetchAsset:output_type -> c2.FetchAssetResponse
	17, // 40: c2.C2.ReportCredential:output_type -> c2.ReportCredentialResponse
	19, // 41: c2.C2.ReportFact:output_type -> c2.ReportFactResponse
	21, // 42: c2.C2.ReportFile:output_type -> c2.ReportFileResponse
	23, // 43: c2.C2.ReportProcessList:output_type -> c2.ReportProcessListResponse
	25, // 44: c2.C2.ReportTaskOutput:output_type -> c2.ReportTaskOutputResponse
	27, // 45: c2.C2.ReverseShell:output_type -> c2.ReverseShellResponse
	29, // 46: c2.C2.CreatePortal:output_type -> c2.CreatePortalResponse
