...
const file_conv_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"conv.proto\x12\x04conv\"\xdb\x01\n" +
	"\n" +
	"ConvPacket\x12$\n" +
	"\x04type\x18\x01 \x01(\x0e2\x10.conv.PacketTypeR\x04type\x12\x1a\n" +
	...
	"\x05crc32\x18\x05 \x01(\rR\x05crc32\x12\"\n" +
	"\x04acks\x18\a \x03(\v2\x0e.conv.AckRangeR\x04acks\x12\x14\n" +
	...
	"\x14PACKET_TYPE_COMPLETE\x10\x05B%Z#realm.pub/tavern/internal/c2/convpbb\x06proto3"
