...
// Fact reported on the host system.
type Fact struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Fact) Reset() {
	*x = Fact{}
	mi := &file_eldritch_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Fact) Descriptor() ([]byte, []int) {
	return file_eldritch_proto_rawDescGZIP(), []int{6}
}
...
const file_eldritch_proto_rawDesc = "" +
	...
	"\x05chunk\x18\x02 \x01(\fR\x05chunk\"0\n" +
	"\x04Fact\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05valueB\"Z realm.pub/tavern/internal/c2/epbb\x06proto3"
...
var file_eldritch_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_eldritch_proto_goTypes = []any{
	...
	(*Fact)(nil),         // 8: eldritch.Fact
	nil,                  // 9: eldritch.Tome.ParametersEntry
}
var file_eldritch_proto_depIdxs = []int32{
	9, // 0: eldritch.Tome.parameters:type_name -> eldritch.Tome.ParametersEntry
