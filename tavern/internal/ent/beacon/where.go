...
func HasHistory() predicate.Beacon {
	return predicate.Beacon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasHistoryWith(preds ...predicate.BeaconHistory) predicate.Beacon {
	return predicate.Beacon(func(s *sql.Selector) {
		step := newHistoryStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasEvents() predicate.Beacon {
	return predicate.Beacon(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEventsWith(preds ...predicate.Event) predicate.Beacon {
	return predicate.Beacon(func(s *sql.Selector) {
		step := newEventsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
