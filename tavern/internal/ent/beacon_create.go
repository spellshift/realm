...
func (bc *BeaconCreate) SetTransport(b beacon.Transport) *BeaconCreate {
	bc.mutation.SetTransport(b)
	return bc
}

// SetNillableTransport sets the "transport" field if the given value is not nil.
func (bc *BeaconCreate) SetNillableTransport(b *beacon.Transport) *BeaconCreate {
	if b != nil {
		bc.SetTransport(*b)
	}
	return bc
...
func (bc *BeaconCreate) defaults() {
	...
	if _, ok := bc.mutation.Transport(); !ok {
		v := beacon.DefaultTransport
		bc.mutation.SetTransport(v)
	}
}
...
// SetTransport sets the "transport" field.
func (u *BeaconUpsert) SetTransport(v beacon.Transport) *BeaconUpsert {
...
// SetTransport sets the "transport" field.
func (u *BeaconUpsertOne) SetTransport(v beacon.Transport) *BeaconUpsertOne {
	return u.Update(func(s *BeaconUpsert) {
		s.SetTransport(v)
	})
}
...
// SetTransport sets the "transport" field.
func (u *BeaconUpsertBulk) SetTransport(v beacon.Transport) *BeaconUpsertBulk {
	return u.Update(func(s *BeaconUpsert) {
		s.SetTransport(v)
	})
}
