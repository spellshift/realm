...
var (
	...
	// ScreenshotOrderFieldPath orders Screenshot by path.
	ScreenshotOrderFieldPath = &ScreenshotOrderField{
		Value: func(s *Screenshot) (ent.Value, error) {
			return s.Path, nil
		},
		column: screenshot.FieldPath,
		toTerm: screenshot.ByPath,
		toCursor: func(s *Screenshot) Cursor {
			return Cursor{
				ID:    s.ID,
				Value: s.Path,
...
func (f ScreenshotOrderField) String() string {
	...
	case ScreenshotOrderFieldLastModifiedAt.column:
		str = "LAST_MODIFIED_AT"
	case ScreenshotOrderFieldPath.column:
		str = "NAME"
