...
func HasShell() predicate.HostCredential {
	return predicate.HostCredential(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasShellWith(preds ...predicate.Shell) predicate.HostCredential {
	return predicate.HostCredential(func(s *sql.Selector) {
		step := newShellStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasShellTask() predicate.HostCredential {
	return predicate.HostCredential(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasShellTaskWith(preds ...predicate.ShellTask) predicate.HostCredential {
	return predicate.HostCredential(func(s *sql.Selector) {
