...
var (
	...
	HostCredentialsColumns = []*schema.Column{
		...
		{Name: "shell_reported_credentials", Type: field.TypeInt, Nullable: true},
	...
	HostCredentialsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "host_credentials_shells_reported_credentials",
			...
			},
			{
				...
				Columns:    []*schema.Column{HostCredentialsColumns[9]},
	...
	HostFilesColumns = []*schema.Column{
		...
		{Name: "shell_reported_files", Type: field.TypeInt, Nullable: true},
	...
	HostFilesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "host_files_shells_reported_files",
	...
	HostProcessesColumns = []*schema.Column{
		...
		{Name: "shell_reported_processes", Type: field.TypeInt, Nullable: true},
	...
	HostProcessesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "host_processes_shells_reported_processes",
...
func init() {
	...
	HostCredentialsTable.ForeignKeys[1].RefTable = ShellsTable
	HostCredentialsTable.ForeignKeys[2].RefTable = ShellTasksTable
	HostCredentialsTable.ForeignKeys[3].RefTable = TasksTable
	...
	HostFilesTable.ForeignKeys[2].RefTable = ShellsTable
	HostFilesTable.ForeignKeys[3].RefTable = ShellTasksTable
	HostFilesTable.ForeignKeys[4].RefTable = TasksTable
	...
	HostProcessesTable.ForeignKeys[2].RefTable = ShellsTable
