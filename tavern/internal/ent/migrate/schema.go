...
var (
	...
	EventsColumns = []*schema.Column{
		...
		{Name: "kind", Type: field.TypeEnum, Enums: []string{"BEACON_LOST", "HOST_ACCESS_NEW", "HOST_ACCESS_RECOVERED", "HOST_ACCESS_LOST", "QUEST_COMPLETED", "SHELL_CREATED"}},
		...
		{Name: "shell_events", Type: field.TypeInt, Nullable: true},
...
func init() {
	...
	EventsTable.ForeignKeys[3].RefTable = ShellsTable
	EventsTable.ForeignKeys[4].RefTable = UsersTable
