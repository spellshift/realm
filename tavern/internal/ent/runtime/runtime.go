...
func init() {
	...
	// screenshotDescPath is the schema descriptor for path field.
	screenshotDescPath := screenshotFields[0].Descriptor()
	// screenshot.PathValidator is a validator for the "path" field. It is called by the builders before save.
	screenshot.PathValidator = screenshotDescPath.Validators[0].(func(string) error)
	// screenshotDescSize is the schema descriptor for size field.
	screenshotDescSize := screenshotFields[4].Descriptor()
	...
	screenshotDescHash := screenshotFields[5].Descriptor()
