...
type ShellTaskEdges struct {
	...
	// Files that have been reported by this shell task.
	ReportedFiles []*HostFile `json:"reported_files,omitempty"`
	// Processes that have been reported by this shell task.
	ReportedProcesses []*HostProcess `json:"reported_processes,omitempty"`
	// Credentials that have been reported by this shell task.
