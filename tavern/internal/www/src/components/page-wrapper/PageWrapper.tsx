...
const navigation = [
  { name: PageNavItem.quests, href: '/quests', icon: ClipboardDocumentCheckIcon, internal: true},
  { name: PageNavItem.createQuest, href:'/createQuest', icon:CommandLineIcon, internal: true },
  { name: PageNavItem.results, href: '/output-results', icon: TrophyIcon, internal: true},
