import { Steps, Heading, Text, Stack, Box, Switch, Field } from "@chakra-ui/react";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="flex-1 flex flex-col gap-2">
                            <div className="flex flex-row-reverse md:flex-row gap-1 justify-end">
                                ...
                                <Switch.Root id='isSelected' className="pt-1" colorPalette="purple" onCheckedChange={() => setViewOnlySelected((value) => !value)}>
                                    <Switch.HiddenInput />
                                    <Switch.Control>
                                        <Switch.Thumb />
                                    </Switch.Control>
                            ...
                            >
                                <div className="flex flex-row-reverse md:flex-row gap-1 justify-end">
                                    ...
                                    <Switch.Root id='isOnePerHost' className="pt-1" colorPalette="purple" onCheckedChange={() => setViewOnlyOnePerHost((value) => !value)}>
                                        <Switch.HiddenInput />
                                        <Switch.Control>
                                            <Switch.Thumb />
                                        </Switch.Control>
