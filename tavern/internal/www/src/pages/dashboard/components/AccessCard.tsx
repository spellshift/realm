...
const AccessCard = ({ hosts }: { hosts: any }) => {
    ...
    return (
        <div className="grid grid-cols-5 gap-6  bg-white rounded-lg shadow-lg p-4">
            <h3 className="text-xl col-span-5">
                Access status
            </h3>
            <div className="col-span-5 md:col-span-1 flex flex-row md:flex-col gap-4 flex-wrap">
