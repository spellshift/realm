...
import { Heading, Switch, Field } from "@chakra-ui/react";
        ...
        <div className="flex flex-col gap-2 my-2">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex flex-row-reverse md:flex-row gap-1 justify-center">
                    ...
                    <Switch.Root id='groupByPrincipal' className="pt-1" colorPalette="purple" onCheckedChange={(e: any) => setGroupByPrincipal(!!e.checked)}>
                        <Switch.HiddenInput />
                        <Switch.Control>
                            <Switch.Thumb />
                        </Switch.Control>
