...
interface WinrmConnectionModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConnect: (target: string) => void;
}

const WinrmConnectionModal: React.FC<WinrmConnectionModalProps> = ({ isOpen, onClose, onConnect }) => {
                    ...
                    >
                        <Dialog.Panel className="w-full max-w-md rounded-lg bg-[#2d2d2d] border border-[#444] shadow-xl">
                            ...
                            <form onSubmit={handleSubmit} className="px-5 py-4">
                                <div className="mb-4">
                                    <label htmlFor="winrm-target" className="block text-sm font-medium text-gray-300 mb-2">
                                        Target
                                    </label>
                                    <input
                                        id="winrm-target"
                                        ...
                                        placeholder="Administrator:password@host:5985"
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        The WinRM destination to connect to via the active portal.
                                    </p>
                                </div>
...
export default WinrmConnectionModal;
