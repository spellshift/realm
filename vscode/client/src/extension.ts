...
function additionalClientSettings(): AdditionalClientSettings {
    return {
        enable_goto_definition: vscode.workspace.getConfiguration().get("eldritch.enableGotoDefinition", true),
    };
}
...
export function activate(context: ExtensionContext) {
    ...
    const path: string = requireSetting("eldritch.lspPath");
    const args: [string] = requireSetting("eldritch.lspArguments");
